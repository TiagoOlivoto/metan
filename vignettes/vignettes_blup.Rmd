...
The **waasby** index (a "mixed-effect model version of the **waasy** index") is used for genotype ranking considering both the stability (**waasb**) and mean performance (**y**) based on the following model:
