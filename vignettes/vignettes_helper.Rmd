...
AMMI0 = cv_ammi(data_ge, ENV, GEN, REP, GY, naxis = 0, nboot = 100)
AMMI2 = cv_ammi(data_ge, ENV, GEN, REP, GY, naxis = 2, nboot = 100)
AMMI9 = cv_ammi(data_ge, ENV, GEN, REP, GY, naxis = 9, nboot = 100)
AMMIF = cv_ammif(data_ge, ENV, GEN, REP, GY, nboot = 100)
BLUP = cv_blup(data_ge, ENV, GEN, REP, GY, nboot = 100)
