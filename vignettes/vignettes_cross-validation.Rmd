...
BLUP_g = cv_blup(data_ge, ENV, GEN, REP, GY, nboot = 50, nrepval = 2, random = "gen")

# Environment, replication-whitin-environment and interaction as random effects
BLUP_e = cv_blup(data_ge, ENV, GEN, REP, GY, nboot = 50, nrepval = 2, random = "env")

# A random model (all terms as random effects)
BLUP_ge = cv_blup(data_ge, ENV, GEN, REP, GY, nboot = 50, nrepval = 2, random = "all")
