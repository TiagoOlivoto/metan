...
In this section, we will use the data in `data_ge2`. For more information, please, see `?data_ge2`. Other data sets can be used provided that the following columns are in the data_ge: environment, genotype, block/replicate and response variable(s).
