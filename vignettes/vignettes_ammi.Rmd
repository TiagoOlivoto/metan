...
library(tidyverse) # used to set plot themes
...
g <- plot_waasby(waas_index)
h <- plot_waasby(waas_index, col.shape = c("gray20", "gray80"))
arrange_ggplot(g, h, letters[7:8])
    ```
