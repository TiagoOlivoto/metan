...
The function `desc_stat()` may be used to compute measures of central tendency, position, and dispersion. Use `hist = TRUE` to create a histrogram for each variable.
