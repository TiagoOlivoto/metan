...
# Getting started
In this section we will use the data examples `data_ge` and `data_ge2`  provided in the METAAB package. For more information, please, see `?data_ge` and `?data_ge2`. Other data sets can be used provided that the following columns are in the dataset: environment, genotype, block/replicate and response variable(s).
