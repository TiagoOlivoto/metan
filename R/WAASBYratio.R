...
MGEN = data.frame(type = "GEN", Code = rownames(OUTMED),Y = apply(OUTMED, 1, mean), MEscores)
MENV = data.frame(type = "ENV", Code = colnames(OUTMED), Y = apply(OUTMED, 2, mean), NEscores)
