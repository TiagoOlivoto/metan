...
#'  average of the absolute scores; \code{"PctResp"} and \code{"PctWAASB"} for the rescaled
...
#'  for the superiority index, \code{"OrWAASBY"} for the ranking regarding the superiority
#'  index.
