...
### Fitting the model
The AMMI model is fitted with the function `waas()`, which is the acronym for the weighted average of absolute scores [@Olivoto2019]. For more details, please see `?waas`.
