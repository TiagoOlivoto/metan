...
Quando mais de uma variável é ajustada, os meios previstos para a combinação genótipo versus ambiente podem ser obtidos para todas as variáveis no modelo usando `get_model_data()`.
